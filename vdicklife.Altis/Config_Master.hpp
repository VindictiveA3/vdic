...
/* System Settings */
    ...
    fuelCan_refuel = 200; //Cost to refuel an empty fuel canister at the fuel station pumps. (Be wary of your buy/sell prices on fuel cans to prevent exploits...)

    /* Gang System Configurations */
    gang_price = 5000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    gang_upgradeBase = 1500; //The base cost for purchasing additional slots in a gang
    ...
    bank_med = 7000; //Amount of cash in bank for new medics
    ...
    vehicle_purchase_multiplier_MEDIC = .45; //Medic Vehicle Buy Price = Config_Vehicle price * multiplier
    ...
    vehicle_rental_multiplier_COP = .65; //Cop Vehicle Rental Price = Config_Vehicle price * multiplier
    ...
    vehicle_cop_impound_multiplier = .13; //TO AVOID EXPLOITS NEVER SET HIGHER THAN A PURCHASE/RENTAL multipler!   Payout = Config_vehicle Price * multiplier
